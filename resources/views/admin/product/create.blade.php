                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{ asset('uploads/products/thumbnail/no-image.jpg') }}" alt="" style="width: 150px; height: 150px;" id="product-thumbnail-show">
                            </div>
                        </div>
                        <div class="form-group row">
                            {!! Form::label(trans('home.image_description'), null, ['class' => 'col-sm-4 col-form-label control-label', 'id' => 'uploadFile']) !!}
                            <div class="col-sm-8">
